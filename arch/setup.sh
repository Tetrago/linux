...
packages=( caffeine-ng neovim-symlinks nerd-fonts-fira-code archlinux-wallpaper google-chrome dtrx dmscripts-git shell-color-scripts glow ark polybar bsp-layout )
